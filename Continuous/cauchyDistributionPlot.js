...
class cauchyDistributionPlot extends baseModal {
    static dialogId = 'cauchyDistributionPlot'
    static t = baseModal.makeT(cauchyDistributionPlot.dialogId)

    constructor() {
        var config = {
            id: cauchyDistributionPlot.dialogId,
            label: cauchyDistributionPlot.t('title'),
            modalType: "one",
            RCode: `
            local(
                {
        ...
        var objects = {
            location: {
                el: new input(config, {
                    no: 'location',
                    label: cauchyDistributionPlot.t('location'),
                    required: true,
                    placeholder: "0",
                    allow_spaces:true,
                    type : "numeric",
            ...
            scale: {
                el: new input(config, {
                    no: 'scale',
                    label: cauchyDistributionPlot.t('scale'),
                    required: true,
                    placeholder: "1",
                    allow_spaces:true,
                    type : "numeric",
            ...
            plotdenfun: { el: new radioButton(config, { label: cauchyDistributionPlot.t('pdenfun'), no: "a", increment: "TRUE", style:"mt-3", value: "TRUE", state: "checked", extraction: "ValueAsIs" }) },
            plotdistfun: { el: new radioButton(config, { label: cauchyDistributionPlot.t('pdstfun'), no: "a", increment: "FALSE", value: "FALSE", state: "", extraction: "ValueAsIs" }) },

            lblRegUndr: { el: new labelVar(config, { label: cauchyDistributionPlot.t('lblregions'), style: "mt-3",h: 5 }) },
            xvalrad: { el: new radioButton(config, { label: cauchyDistributionPlot.t('xvals'), no: "b", increment: "TRUE", value: "TRUE", state: "checked", extraction: "ValueAsIs" }) },
            quntlrad: { el: new radioButton(config, { label: cauchyDistributionPlot.t('quantiles'), no: "b", increment: "FALSE", value: "FALSE", state: "", extraction: "ValueAsIs" }) },

            lblRegiFill: { el: new labelVar(config, { label: cauchyDistributionPlot.t('lblRegFill'), style: "mt-3",h: 5 }) },

            lblRegion1: { el: new labelVar(config, { label: cauchyDistributionPlot.t('lblreg1'), style: "mt-3",h: 6 }) },
            reg1Frm: {
                el: new input(config, {
                    no: 'reg1frm',
                    label: cauchyDistributionPlot.t('lblregfrm'),
                    placeholder: "",
                    allow_spaces:true,
                    type : "numeric",
                    extraction: "TextAsIs",
            ...
            reg1To: {
                el: new input(config, {
                    no: 'reg1to',
                    label: cauchyDistributionPlot.t('lblregto'),
                    placeholder: "",
                    allow_spaces:true,
                    type : "numeric",
                    extraction: "TextAsIs",
            ...
            reg1Col: {
                el: new colorInput(config, {
                    no: 'reg1col',
                    label: cauchyDistributionPlot.t('lblregcol'),
                    placeholder: "#BEBEBE",
                    allow_spaces:true,
                    type: "character",
                    extraction: "TextAsIs",
            ...
            lblRegion2: { el: new labelVar(config, { label: cauchyDistributionPlot.t('lblreg2'), style: "mt-3",h: 6 }) },
            reg2Frm: {
                el: new input(config, {
                    no: 'reg2frm',
                    label: cauchyDistributionPlot.t('lblregfrm'),
            ...
            lblLegposi: { el: new labelVar(config, { label: cauchyDistributionPlot.t('lblLegPos'), style: "mt-3",h: 5 }) },
            toprtrad: { el: new radioButton(config, { label: cauchyDistributionPlot.t('toprt'), no: "c", increment: "TRUE", value: "topright", state: "checked", extraction: "ValueAsIs" }) },
            topltrad: { el: new radioButton(config, { label: cauchyDistributionPlot.t('toplt'), no: "c", increment: "FALSE", value: "topleft", state: "", extraction: "ValueAsIs" }) },
            topmidrad: { el: new radioButton(config, { label: cauchyDistributionPlot.t('topmid'), no: "c", increment: "FALSE", value: "top", state: "", extraction: "ValueAsIs" }) }
        }
        const content = {
            ...
            nav: {
                name: cauchyDistributionPlot.t('navigation'),
                icon: "icon-c",
...
module.exports = {
    render: () => new cauchyDistributionPlot().render()
}
