...
class fDistributionPlot extends baseModal {
    static dialogId = 'fDistributionPlot'
    static t = baseModal.makeT(fDistributionPlot.dialogId)

    constructor() {
        var config = {
            id: fDistributionPlot.dialogId,
            label: fDistributionPlot.t('title'),
            modalType: "one",
            RCode: `
            local(
                {
        ...
        var objects = {
            dfnumerator: {
                el: new input(config, {
                    no: 'dfnumerator',
                    label: fDistributionPlot.t('dfnumerator'),
                    required: true,
                    placeholder: "0",
                    allow_spaces:true,
                    type : "numeric",
            ...
            dfdenominator: {
                el: new input(config, {
                    no: 'dfdenominator',
                    label: fDistributionPlot.t('dfdenominator'),
                    required: true,
                    placeholder: "0",
                    allow_spaces:true,
                    type : "numeric",
            ...
            plotdenfun: { el: new radioButton(config, { label: fDistributionPlot.t('pdenfun'), no: "a", increment: "TRUE", style:"mt-3", value: "TRUE", state: "checked", extraction: "ValueAsIs" }) },
            plotdistfun: { el: new radioButton(config, { label: fDistributionPlot.t('pdstfun'), no: "a", increment: "FALSE", value: "FALSE", state: "", extraction: "ValueAsIs" }) },

            lblRegUndr: { el: new labelVar(config, { label: fDistributionPlot.t('lblregions'), style: "mt-3",h: 5 }) },
            xvalrad: { el: new radioButton(config, { label: fDistributionPlot.t('xvals'), no: "b", increment: "TRUE", value: "TRUE", state: "checked", extraction: "ValueAsIs" }) },
            quntlrad: { el: new radioButton(config, { label: fDistributionPlot.t('quantiles'), no: "b", increment: "FALSE", value: "FALSE", state: "", extraction: "ValueAsIs" }) },

            lblRegiFill: { el: new labelVar(config, { label: fDistributionPlot.t('lblRegFill'), style: "mt-3",h: 5}) },

            lblRegion1: { el: new labelVar(config, { label: fDistributionPlot.t('lblreg1'), style: "mt-3",h: 6 }) },
            reg1Frm: {
                el: new input(config, {
                    no: 'reg1frm',
                    label: fDistributionPlot.t('lblregfrm'),
                    placeholder: "",
                    allow_spaces:true,
                    type : "numeric",
                    extraction: "TextAsIs",
            ...
            reg1To: {
                el: new input(config, {
                    no: 'reg1to',
                    label: fDistributionPlot.t('lblregto'),
                    placeholder: "",
                    allow_spaces:true,
                    type : "numeric",
                    extraction: "TextAsIs",
            ...
            reg1Col: {
                el: new colorInput(config, {
                    no: 'reg1col',
                    label: fDistributionPlot.t('lblregcol'),
                    placeholder: "#BEBEBE",
                    allow_spaces:true,
                    type: "character",
                    extraction: "TextAsIs",
            ...
            lblRegion2: { el: new labelVar(config, { label: fDistributionPlot.t('lblreg2'), style: "mt-3",h: 6 }) },
            reg2Frm: {
                el: new input(config, {
                    no: 'reg2frm',
                    label: fDistributionPlot.t('lblregfrm'),
            ...
            lblLegposi: { el: new labelVar(config, { label: fDistributionPlot.t('lblLegPos'), style: "mt-3",h: 5 }) },
            toprtrad: { el: new radioButton(config, { label: fDistributionPlot.t('toprt'), no: "c", increment: "TRUE", value: "topright", state: "checked", extraction: "ValueAsIs" }) },
            topltrad: { el: new radioButton(config, { label: fDistributionPlot.t('toplt'), no: "c", increment: "FALSE", value: "topleft", state: "", extraction: "ValueAsIs" }) },
            topmidrad: { el: new radioButton(config, { label: fDistributionPlot.t('topmid'), no: "c", increment: "FALSE", value: "top", state: "", extraction: "ValueAsIs" }) }
        }
        const content = {
            ...
            nav: {
                name: fDistributionPlot.t('navigation'),
                icon: "icon-f-g",
        ...
        this.help = {
            title: fDistributionPlot.t('help.title'),
            r_help: fDistributionPlot.t('help.r_help'),  //r_help: "help(data,package='utils')",
            body: fDistributionPlot.t('help.body')
        }
;
    }
}
...
module.exports = {
    render: () => new fDistributionPlot().render()
}
